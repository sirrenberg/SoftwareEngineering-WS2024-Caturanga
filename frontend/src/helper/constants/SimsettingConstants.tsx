...
export const awarenessLevelOptions = [
  ...
  {
    value: 2,
    label: "The type of the settlement adjacent to neighboring settlements",
  },
  {
    value: 3,
    label: "The type of the settlements neighboring neighbors of neighbors",
  },
];
...
export const usePopForLocWeightText = `
    ...
    By default this is ${
      defaultValues.move_rules.use_pop_for_loc_weight
        ? "checked"
        : "NOT checked"
    }.
    `;
...
export const awarenessLevelText = `
    ...
    The default value is: "${
      awarenessLevelOptions[defaultValues.move_rules.awareness_level + 1].label
    }".
    `;
...
export const startOnFootText = `
    ...
    By default it is ${
      defaultValues.move_rules.start_on_foot ? "checked" : "NOT checked"
    }.
    `;
