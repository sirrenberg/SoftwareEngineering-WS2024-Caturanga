    ...
    def run_data_extraction(self, country_name, start_date, end_date, max_simulation_end_date):
        try:
            ...
            if date_format(start_date) > date_format(end_date):
                return {"success": False, "error": "Start date is after the end date of fetching."}
            elif date_format(start_date) > date_format(max_simulation_end_date):
                return {"success": False, "error": "Start date is after simulation end date."}
